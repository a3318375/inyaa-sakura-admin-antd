...
import { currentUser as queryCurrentUser } from './services/mock/api';
import { info } from './services/ant-design-pro/userAdmin';
...
export async function getInitialState(): Promise<{
  ...
  const fetchUserInfo = async () => {
    try {
      ...
      if (error && error.response.status.data.code === 1001) {
...
export const request = {
  errorConfig: {
    ...
    adaptor: (resData: { data: any; code: number; message: string; }) => {
      return {
        data: resData.data,
